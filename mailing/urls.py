...
urlpatterns = [
    ...
    path(
        "contacts/<int:contact_id>/state/",
        views.contact_state_update,
        name="contact_state_update",
    ),
    path(
        "contacts/<int:contact_id>/subscriptions/",
        views.contact_subscription_update,
        name="contact_subscription_update",
    ),
    path("contacts/<int:contact_id>/tags/add/", views.contact_tag_add, name="contact_tag_add"),
    path(
        "contacts/<int:contact_id>/tags/remove/",
