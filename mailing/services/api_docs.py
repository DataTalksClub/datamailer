...
OPENAPI_SPEC = {
    ...
    "info": {
        ...
        "version": "1.0.0",
        "description": "Local operator reference for implemented Datamailer endpoints. Client API routes use Bearer authentication with Datamailer client API keys. Transactional templates are planned for catalog management and may be provisioned externally for now.",
    },
    "servers": [{"url": "/"}],
    "tags": [
        {"name": "Contacts"},
