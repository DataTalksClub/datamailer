...
class ProductRouteTests(SimpleTestCase):
    def test_product_ui_routes_do_not_use_operator_prefix(self):
        route_expectations = [
            ...
            ("contact_detail", [123], "/contacts/123/"),
            ("contact_state_update", [123], "/contacts/123/state/"),
            ("contact_subscription_update", [123], "/contacts/123/subscriptions/"),
            ("contact_tag_add", [123], "/contacts/123/tags/add/"),
            ("contact_tag_remove", [123], "/contacts/123/tags/remove/"),
            ("api_docs", [], "/api-docs/"),
